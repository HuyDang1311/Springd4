...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="${pageContext.request.contextPath }/cnews/index"><span>Vina</span>Enter<br />
          <small>Đã Học Là Làm Được</small></a></h1>
      </div>
      <div class="clr"></div>
      <div class="menu">
        <ul>
          <li><a href="${pageContext.request.contextPath }/cnews/index" class="active"><span>Trang chủ</span></a></li>
          <li><a href="${pageContext.request.contextPath }/cnews/add"><span>Đăng tin</span></a></li>
        </ul>
      </div>
      <div class="clr"></div>
    </div>
